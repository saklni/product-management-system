/**
 * Centralized icon set (outline style, stroke="currentColor").
 * Previously these same <svg> blocks were copy-pasted verbatim across
 * 5-6 different page files. Now there's a single source of truth.
 */
...
export function CartCheckoutIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
...
export function LogoMark({ size = 40, gradientId = "logo-grad" }: { size?: number; gradientId?: string }) {
  return (
